...
const StepIcon = ({ icon }: { icon: string }) => (
  <div className="relative mb-8 group-hover:scale-110 transition-transform duration-500">
    <div className="absolute inset-0 bg-gradient-radial from-unc-light-blue/30 to-transparent rounded-full transform scale-150 blur-xl opacity-50 group-hover:opacity-100 group-hover:scale-175 transition-all duration-500"></div>
    <div className="bg-gradient-to-br from-unc-blue to-unc-navy w-24 h-24 rounded-full flex items-center justify-center mx-auto relative">
      <div className="text-white w-12 h-12" dangerouslySetInnerHTML={{ __html: icon }} />
    </div>
  </div>
);
